...
class _HomeScreenState extends State<HomeScreen> {
 ...
 List<Tratamiento> _filtrarTratamientos(List<Tratamiento> tratamientos) {
   if (mostrandoPendientes) {
     return tratamientos.where((t) => t.estadoAutorizacion.toUpperCase() == 'PENDIENTE').toList();
   } else {
     return tratamientos.where((t) => 
       t.estadoAutorizacion.toUpperCase() == 'APROBADO' || 
       t.estadoAutorizacion.toUpperCase() == 'RECHAZADO'
     ).toList();
   }
 }
         ...
         actions: <Widget>[
           ...
           TextButton(
             ...
             onPressed: () async {
               ...
               if (isAuthenticated) {
                 try {
                   await _tratamientoService.actualizarEstadoTratamiento(
                       tratamiento.id, 'APROBADO');
                   Navigator.of(context).pop();
                   ...
                   ScaffoldMessenger.of(context).showSnackBar(
                     SnackBar(
                         content: Text('Error al autorizar el tratamiento: $e')),
                   );
                 }
               } else {
                 ScaffoldMessenger.of(context).showSnackBar(
             ...
             onPressed: () async {
               ...
               if (isAuthenticated) {
                 try {
                   ...
                   ScaffoldMessenger.of(context).showSnackBar(
                     SnackBar(
                         content: Text('Error al rechazar el tratamiento: $e')),
                   );
                 }
               } else {
                 ScaffoldMessenger.of(context).showSnackBar(
             ...
             children: [
               ElevatedButton(
                 ...
                 style: ElevatedButton.styleFrom(
                   backgroundColor: mostrandoPendientes
                       ? Color(0xFF2A9D8F)
                       : Color(0xFF1D3557),
                 ),
               ),
             ...
             child: FutureBuilder<List<Tratamiento>>(
               ...
               builder: (context, snapshot) {
                 if (snapshot.connectionState == ConnectionState.waiting) {
                   ...
                   final tratamientosFiltrados =
                       _filtrarTratamientos(snapshot.data!);
                   ...
                   return ListView.builder(
                     ...
                     itemBuilder: (context, index) {
                       ...
                       return Card(
                         ...
                         child: InkWell(
                           onTap: () =>
                               _showAutorizationDialog(context, tratamiento),
                           child: Padding(
                                     ...
                                     children: [
                                       Row(
                                         ...
                                         children: [
                                           ...
                                           _buildStatusLabel(
                                               tratamiento.estadoAutorizacion),
                                         ],
                                       ),
                                       SizedBox(height: 4),
                                       Text('Fecha: ${tratamiento.fecha}'),
